...
<div style={{ fontStyle: "italic", maxWidth: "50em", paddingTop:"0.1rem" }}>
  Jan Kulveit, Raymond Douglas, Nora Ammann, Deger Turan, David Krueger, David Duvenaud<Footnote mark="*">Equal contribution: JK and RD; ACS research, Charles University: JK and NA; Telic Research: RD; Advanced Research + Invention Agency (ARIA): NA; AI Objectives Institute and Metaculus: DT; Mila, University of Montreal and University of Toronto: DD</Footnote>
</div>


<img src="/gradfig1.png" alt="Mutual Reinforcement illustration" style={{width:"100%", margin:"0 auto"}} />
